            ...
            <form action="{{ route('login-action') }}" method="POST"
                ...
                <div
                    ...
                    @if ($message = Session::get('failed'))
                        <div class="intro-y alert alert-danger alert-dismissible show flex items-center mb-2 mt-2"
                            role="alert">
                            <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> Email / Password incorrect!
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Manage all your properties in one
                        place</div>
