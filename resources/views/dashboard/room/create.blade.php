    ...
    <div class="col-span-12 mt-8">
        ...
        <form class="intro-y box p-5" action="{{ route('rooms.store') }}" method="POST">
            ...
            <div class="mt-3">
                ...
                <textarea id="crud-form-3" name="description" class="form-control w-full" placeholder="Description" rows="6"></textarea>
            </div>
            <div class="mt-3">
                ...
                <div class="input-group">
                    <input id="crud-form-4" type="number" name="capacity" class="form-control"
                        placeholder="Input capacity room" aria-describedby="input-group-2">
                </div>
            </div>
            <div class="mt-3">
                ...
                <div class="input-group">
                    <input id="crud-form-4" type="number" name="room_size" class="form-control"
                        placeholder="Input room size" aria-describedby="input-group-2">
                </div>
            </div>
            <div class="mt-3">
